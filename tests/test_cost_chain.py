...
class TestSmallCostChainEnv(unittest.TestCase):
    ...
    def test_a(self):
        ...
        for step in range(1, self.horizon - 1, 2):
            ...
            if state_odd_step % 2:
                ...
                self.assertAlmostEqual(reward, 1/(self.n * 2))
            else:
    ...
    def test_reset(self):
        ...
        for _ in range(self.horizon - 1):
            ...
            self.assertAlmostEqual(reward, 1/self.n)
            self.assertEqual(info['cost'], 0)
            self.assertFalse(done)
        ...
        self.assertEqual(reward, 1/self.n)
        self.assertEqual(info['cost'], 0)
        self.assertTrue(done)
...
class TestCostChainEnv(TestSmallCostChainEnv):
    ...
    def setUpClass(cls):
        ...
        cls.env = gym.make("gym_factored:cost_chain_regular-v0", prob_y_zero=cls.p, n=cls.n)
